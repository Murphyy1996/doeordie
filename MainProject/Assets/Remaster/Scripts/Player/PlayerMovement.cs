...
//Script Purpose: To set up and create player movement
//Where the script should be placed: On the player object
...
public class PlayerMovement : MonoBehaviour
{
    ...
    private BoxCollider boundryCollider;
    ...
    private void Start() //Get all required components
    {
        //Get this character controller and transform
        thisCC = GetComponent<CharacterController>();
        thisTransform = GetComponent<Transform>();
        //Make the box collider a trigger
        boundryCollider = GetComponent<BoxCollider>();
        boundryCollider.isTrigger = true;
